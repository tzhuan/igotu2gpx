...
#else
    // Test for GCC >= 4.0.0
    #if __GNUC__ * 100 + __GNUC_MINOR__ * 10 + __GNUC_PATCHLEVEL >= 400
        #define QEXTSERIALPORT_EXPORT __attribute__ ((visibility ("default")))
    #endif
#endif
#ifndef QEXTSERIALPORT_EXPORT
